        ...
        content:`
            ...
            <h1 class="subtitle">Edit a Product</h1>
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <p class="help is-danger">${getError(err, 'title')}</p>
                    </div>
                    
                    <div class="field">
                    <label class="label">Price</label>
                    <input value="${product.price}" class="input" placeholder="Price" name="price">
                    <p class="help is-danger">${getError(err, 'price')}</p>
                    </div>
...
//?  value="${product.img}" can't be represented as input is type file while value stored is in bits
